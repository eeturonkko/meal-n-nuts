...
const insertEntry = db.prepare(
  `INSERT INTO meal_entries
   (user_id, date, meal, name, amount, unit, calories, protein, carbohydrate, fat, source, created_at)
   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, datetime('now'))`
);
...
const listDayEntriesStmt = db.prepare(
  `SELECT id, meal, name, amount, unit, calories, protein, carbohydrate, fat
   FROM meal_entries
...
const readEntryStmt = db.prepare(
  `SELECT id, user_id, date, meal, name, amount, unit, calories, protein, carbohydrate, fat, source, created_at
   FROM meal_entries
